...
class AosToSoaRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.memory_layout.aos-to-soa"; }
    const char* title() const noexcept override { return "vector-of-structs may benefit from struct-of-vectors"; }
