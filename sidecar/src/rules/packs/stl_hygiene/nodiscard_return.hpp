...
class NodiscardReturnRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.nodiscard.error-return"; }
    const char* title() const noexcept override { return "missing [[nodiscard]] on error-returning function"; }
