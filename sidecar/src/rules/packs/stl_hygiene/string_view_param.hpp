...
class StringViewParamRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.stl.string-view-param"; }
    const char* title() const noexcept override { return "const std::string& param should be std::string_view"; }
