...
class ContainerCopyRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.stl.container-copy"; }
    const char* title() const noexcept override { return "unnecessary container copy"; }
