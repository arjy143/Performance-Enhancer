...
class VirtualDispatchInLoopRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.hotpath.virtual-dispatch"; }
    const char* title() const noexcept override { return "Virtual dispatch inside loop"; }
