...
class AllocationInLoopRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.hotpath.allocation-in-loop"; }
    const char* title() const noexcept override { return "heap allocation inside loop"; }
