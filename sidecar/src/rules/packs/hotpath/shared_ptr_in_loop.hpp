...
class SharedPtrInLoopRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.hotpath.shared-ptr-in-loop"; }
    const char* title() const noexcept override { return "std::shared_ptr copy inside loop"; }
