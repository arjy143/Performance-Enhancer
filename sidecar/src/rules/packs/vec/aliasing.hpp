...
class VecAliasingRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.vec.aliasing"; }
    const char* title() const noexcept override { return "Pointer aliasing prevents vectorisation"; }
