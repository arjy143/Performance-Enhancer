...
class ComplexCfRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.vec.complex-cf"; }
    const char* title() const noexcept override { return "early exit inside loop prevents vectorisation"; }
