...
class PromotionVariableRule final : public Rule {
public:
    const char* id()    const noexcept override { return "perf-lens.constexpr.promotion-variable"; }
    const char* title() const noexcept override { return "const variable can be constexpr"; }
    FindingCategory category()   const noexcept override { return FindingCategory::Constexpr; }
